VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} XLLOADING_AUTOMATEXL 
   ClientHeight    =   1530
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6810
   OleObjectBlob   =   "XLLOADING_AUTOMATEXL.frx":0000
   StartUpPosition =   2  'CenterScreen
End
Attribute VB_Name = "XLLOADING_AUTOMATEXL"
...
If Range("xlasAppLoad").Value = 1 Then XLLOADING_AUTOMATEXL.Hide
...
LoadBg2.Width = LoadBg2.Width - 5 '//change bar size
LoadBg3.BackColor = RGB(B, G, R) '//change bar color
LoadBg3.Width = LoadBg3.Width + 5 '//change bar size
XLLOADING_AUTOMATEXL.BackColor = RGB(R, G, B) '//change background color
...
XLLOADING_AUTOMATEXL.Hide

'//wait...
Art = "<lib>xbas;delayevent(2);$": Call xlas(Art)

'//show refreshed load window
XLLOADING_AUTOMATEXL.Show
